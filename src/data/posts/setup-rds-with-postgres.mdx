...
<img width="760" alt="Screenshot 2022-12-19 at 20 42 34" src="https://user-images.githubusercontent.com/27693622/208517741-e00819ff-c427-451d-a4f2-cdffd7f4af66.png">
...
After that click ‘Create database’ and then wait for it to get created.
After it is created click on the database and then search for Endpoint which is on the ‘Connectivity & security’. (For users who have already created a database on the RDS and want to make it publicly accessible, the only way to do is Create a Snapshot and then restore the database from the Snapshot with publicly accessible ‘Yes’)
