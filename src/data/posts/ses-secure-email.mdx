...
![Movibooker Architecture](./img/ses-secure-email/image9.png)
...
![Be Aware](./img/ses-secure-email/image8.jpg)
...
![Verified Identities](./img/ses-secure-email/image6.png) <!-- You can replace "path/to/screenshot.png" with the actual path to your screenshot or image -->
...
![Enable DKIM Signatures](./img/ses-secure-email/image2.png) <!-- Replace with the actual path to your screenshot or image -->
...
```
![Enable DKIM Signatures](./img/ses-secure-email/image7.png)
...
![Enable DKIM Signatures](./img/ses-secure-email/image10.png)

7. **So here we got all the record sets in place.**
![Enable DKIM Signatures](./img/ses-secure-email/image4.png)
...
![Creating SPF](./img/ses-secure-email/image3.png)
2. **Enter this as value for DNS with Simple type Routing Policy**
![Creating SPF](./img/ses-secure-email/image11.png)
...
![Value for DMARC](./img/ses-secure-email/image12.png)
![Value for DMARC](./img/ses-secure-email/image5.png)
![Value for DMARC](./img/ses-secure-email/image1.png)
